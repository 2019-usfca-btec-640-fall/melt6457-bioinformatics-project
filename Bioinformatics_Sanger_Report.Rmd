...
I used the MAFFT [@katoh2002mafft] multiple sequence aligner to align the trimmed, very good 16S sequences. The MAFFT settings used were scoring matrix of 200PAM / k=12, gap open penalty of 1.53, and offset value of0.123. The six sequences were aligned with a 16S sequence from *Thermus aquaticus*. 
