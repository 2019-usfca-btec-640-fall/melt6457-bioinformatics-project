...
I used the MAFFT [@katoh2002mafft] multiple sequence aligner to align the trimmed, very good 16S sequences. I used the following settings for the MAFFT algorithm: scoring matrix of 200PAM / k=12, gap open penalty of 1.53, and offset value of 0.123. I aligned the six very good sequences with a 16S sequence from *Thermus aquaticus* with accension code NR_025900.1 [@saul1993phylogeny]. I trimmed the *Thermus aquaticus* sequence to the size of the largest sequence in the alignment and ran the alignment a second time.
