...
**Figure 1.** Maximum Likelihood phylogeny of very good sequences using PhyML algorithm. *Thermus aquaticus* was set as an outgroup.

![](data/images/phylogenies/MrBayes_phylogeny.png)

**Figure 2.** Bayesian phylogeny of very good sequences using MrBayes algorithm. *Thermus aquaticus* was set as an outgroup.
...
I matched the 22 very good and acceptable sequences to the BLAST database. I found strong matches for 16 of the samples with 5 samples from *Staphylococcus spp.*, three *Neisseria perflava*, two *E. coli*. All matches to these samples were Bacteria. Only one sample, 3A-B_27f_B04 had a query cover below 90%. Every percent identity was above 80%. OtherThis analysis can be seen below in Table 2. 
