...
**Table 1.** Top 20 genus returned from blast results
...
**Table 2.** Top 20 genus by abundance from curated database
...
**Figure 2.** Number of samples by plot
...
**Figure 3.** Summary of Kingdom found matched in phyloseq.                  
# Sources Cited